...
class TransactionOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_order" do
    assert_difference('TransactionOrder.count') do
      post transaction_orders_url, params: { transaction_order: { amount: @transaction_order.amount, delivery_address: @transaction_order.delivery_address, delivery_name: @transaction_order.delivery_name, delivery_phone: @transaction_order.delivery_phone, delivery_postcode: @transaction_order.delivery_postcode, delivery_state: @transaction_order.delivery_state, transaction_item_id: @transaction_order.transaction_item_id, user_id: @transaction_order.user_id } }
    end
  ...
  test "should update transaction_order" do
    patch transaction_order_url(@transaction_order), params: { transaction_order: { amount: @transaction_order.amount, delivery_address: @transaction_order.delivery_address, delivery_name: @transaction_order.delivery_name, delivery_phone: @transaction_order.delivery_phone, delivery_postcode: @transaction_order.delivery_postcode, delivery_state: @transaction_order.delivery_state, transaction_item_id: @transaction_order.transaction_item_id, user_id: @transaction_order.user_id } }
