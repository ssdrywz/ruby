...
class TransactionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_item" do
    assert_difference('TransactionItem.count') do
      post transaction_items_url, params: { transaction_item: { album_id: @transaction_item.album_id, number: @transaction_item.number, price: @transaction_item.price, user_id: @transaction_item.user_id } }
    end
  ...
  test "should update transaction_item" do
    patch transaction_item_url(@transaction_item), params: { transaction_item: { album_id: @transaction_item.album_id, number: @transaction_item.number, price: @transaction_item.price, user_id: @transaction_item.user_id } }
